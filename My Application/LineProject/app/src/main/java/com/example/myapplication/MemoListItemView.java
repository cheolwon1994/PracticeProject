...
public class MemoListItemView extends LinearLayout {
    ...
    public MemoListItemView(Context context) {
        ...
        inflater.inflate(R.layout.item_memo, this, true);
        itemPhoto = (ImageView) findViewById(R.id.memoImage);
        itemTitle = (TextView) findViewById(R.id.memoTitle);
        itemDate = (TextView) findViewById(R.id.memoDate);
        itemText = (TextView) findViewById(R.id.memoContent);
    }
    public void setContents(int index, String data) {
        if (index == 0) {
            ...
            if (data == null || data.equals("-1") || data.equals("")) {
                itemPhoto.setImageResource(R.drawable.ic_camera);
            } else {
                if (bitmap != null) {
                    bitmap.recycle();
                }
